...
class BartBackboneTest(tf.test.TestCase, parameterized.TestCase):
    def setUp(self):
        ...
        self.input_batch = {
            "encoder_token_ids": tf.ones((2, 5), dtype="int32"),
            "encoder_padding_mask": tf.ones((2, 5), dtype="int32"),
    ...
    def test_variable_sequence_length_call(self):
        for seq_length in (2, 3, 4):
            input_data = {
                "encoder_token_ids": tf.ones((2, seq_length), dtype="int32"),
                "encoder_padding_mask": tf.ones((2, seq_length), dtype="int32"),
